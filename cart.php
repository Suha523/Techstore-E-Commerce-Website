            ...
            <div class="col-lg-10 offset-lg-1">
                <div class="cart_container">
                    ...
                    <div class="cart_items">
                        <ul class="cart_list">
                            <?php  foreach($cart->getAll() as $id=>$prod): ?>
                            <li class="cart_item clearfix">
                                <div class="cart_item_image"><img src="<?=URL?>uploads/<?=$prod['img']?>" alt=""></div>
                                <div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
                                    ...
                                    <div class="cart_item_quantity cart_info_col">
                                        ...
                                        <div class="cart_item_text"><?=$prod['qty']?></div>
                                    </div>
                                    <div class="cart_item_price cart_info_col">
                                        <div class="cart_item_title">Price</div>
                                        <div class="cart_item_text">$<?=$prod['price']?></div>
                                    </div>
                                    <div class="cart_item_total cart_info_col">
                                        <div class="cart_item_title">Total</div>
                                        <div class="cart_item_text">$<?=$prod['qty']*$prod['price']?></div>
                                    </div>
                                    <div class="cart_item_action cart_info_col">
                                        <div class="cart_item_title">Remove</div>
                                        <div class="cart_item_text">
                                            <a href="<?=URL?>handlers/delete_from_cart.php?id=<?=$id?>">
                ...
                <div class="contact_form_container">
                    ...
                    <form method="post" action="<?=URL?>handlers/add_order.php" id="order_form">
                        ...
                        <div class="contact_form_text">
                            <textarea name="address" id="contact_form_message" class="text_field contact_form_message"
                                rows="4" placeholder="Your address"></textarea>
                        </div>
                        <div class="contact_form_button">
                            <button name="submit" type="submit" class="button contact_submit_button">Submit
                                Order</button>
                        </div>
                    </form>
