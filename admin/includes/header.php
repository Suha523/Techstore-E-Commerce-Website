...
<head>
    ...
    <link rel="stylesheet" href="<?=AURL?>assets/css/adminlte.min.css">
    <link rel="stylesheet" href="<?=AURL?>assets/css/toastr.min.css">
            ...
            <ul class="navbar-nav ml-auto mr-5">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                      ...
                      <a class="dropdown-item" href="<?=AURL?>handlers/handle_logout.php">Logout</a>
                    </div>
                </li>
            </ul>
        </div>
